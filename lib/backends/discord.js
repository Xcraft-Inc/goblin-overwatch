  ...
  "embeds": [
    {
      ...
      "image": {
        "url": "https://tenor.com/view/fuuuuuuu-cant-flaming-flames-train-gif-18078311.gif"
      }
    }
  ],
  "username": "Webhook",
...
module.exports = class OverwatchDiscord {
  ...
  _buildDiscordNotif(errors, source, appInfo, agent) {
    ...
    discordNotif.content += `\`\`\`${error.time.toLocaleString()}\n${
      error.err
    }\`\`\``;
  ...
  *send(channels, errors, source, appInfo, agent, log) {
    const body = this._buildDiscordNotif(errors, source, appInfo, agent);
